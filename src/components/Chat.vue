...
let mainChat = ref(null);
let contactsElement = ref();
let activeContacts = ref(false);
...
function displayContacts(){
  activeContacts.value = !activeContacts.value;
}
...
<div class="center">
      <Contacts 
        v-bind:chats="props.data.chats"
        v-bind:callback="changeChat"
        ref="contactsElement"
        :class="{'active-contacts': activeContacts}"
      /> 

      <MainChat
        v-bind:chat_data="mainChat"
        v-bind:callback="displayContacts"
      />
